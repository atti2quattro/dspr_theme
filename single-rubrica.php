<?php
/**
 * Template Name: Rubrica / Editoriale
 * Template Post Type: post
 *
 * Il Dispari – Template Single Post Rubrica
 * @package dspr
 */
...
<main id="primary" class="site-main site-main--rubrica">
<?php while ( have_posts() ) : the_post();
  ...
  $rubrica_nome = get_post_meta( $post_id, '_dspr_rubrica_nome', true );
  // Fallback: usa il nome categoria come nome rubrica se il meta non è impostato
  if ( ! $rubrica_nome ) $rubrica_nome = $cat_nome;
  ...
  $autore_iniziali = strtoupper( mb_substr( get_the_author_meta('first_name'), 0, 1 ) . mb_substr( get_the_author_meta('last_name'), 0, 1 ) );
  ...
  $min_lettura = max( 1, round( $word_count / 200 ) );
...
<!-- BANNER RUBRICA -->
<div class="rubrica-banner">
  <div class="rubrica-banner__inner">
    <div class="rubrica-banner__label">Rubrica</div>
    <div class="rubrica-banner__name"><?php echo esc_html( $rubrica_nome ); ?></div>
  </div>
</div>
...
<?php elseif ( $hero_src ) : ?>
<!-- FOTO IN EVIDENZA — tutta larghezza, tra banner e header -->
<div class="post-hero post-hero--rubrica">
...
<!-- HEADER ARTICOLO RUBRICA -->
<div class="post-header post-header--rubrica">
  ...
  <?php endif; ?>
  <div class="post-meta post-meta--rubrica">
    <?php if ( $autore_avatar ) : ?>
      <img class="post-meta__avatar" src="<?php echo esc_url( $autore_avatar ); ?>"
           alt="<?php echo $autore; ?>" width="40" height="40">
    <?php else : ?>
      <div class="post-meta__avatar-initials"><?php echo $autore_iniziali; ?></div>
    <?php endif; ?>
    <div class="post-meta__text">
      <a class="post-meta__author" href="<?php echo $autore_url; ?>"><?php echo $autore; ?></a>
      <span class="post-meta__date-read">
        <?php echo $data; ?> &middot; <?php echo $min_lettura; ?> min di lettura
      </span>
    </div>
  </div>
</div>
...
<div class="rubrica-ornament">
  <span class="rubrica-ornament__line"></span>
  <span class="rubrica-ornament__mark"></span>
  <span class="rubrica-ornament__line"></span>
</div>

<!-- CORPO ARTICOLO -->
<div class="post-body post-body--rubrica">
...
<!-- FINE ARTICOLO -->
<div class="post-end">
  <span class="post-end__line"></span>
  <span class="post-end__mark"></span>
  <span class="post-end__line"></span>
</div>
...
<div class="post-autore">
  <img class="post-autore__avatar" src="<?php echo esc_url( $autore_avatar ); ?>"
       alt="<?php echo $autore; ?>" width="64" height="64">
...
<!-- CORRELATI — stessi del tema standard -->
<?php
